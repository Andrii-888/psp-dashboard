    ...
    <section className="apple-card p-4 md:p-6">
      <div className="flex flex-col gap-6 md:flex-row">
        ...
        <div className="flex-1 space-y-4">
          ...
          {/* ✅ ONE place only: Amount mismatch warning */}
          {hasAmountMismatch ? (
            <div className="rounded-2xl bg-amber-500/10 p-3 ring-1 ring-amber-500/30">
              ...
              <div className="mt-2 grid grid-cols-[110px_1fr] gap-x-3 gap-y-1 text-[11px]">
                <div className="text-amber-200/70">SSOT cryptoAmount</div>
                <div className="font-mono text-amber-50">
                  {invoice.cryptoAmount} {invoice.cryptoCurrency}
                </div>

                <div className="text-amber-200/70">Provider pay</div>
                <div className="font-mono text-amber-50">
